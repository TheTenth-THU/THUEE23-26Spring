...
&= \underbrace{ \v{x}^{\mathrm{T}} \left( \boldsymbol{C}_{w}^{-1} - (\boldsymbol{C}_{s} + \boldsymbol{C}_{w})^{-1} \right) \v{x} + 2 \v{x}^{\mathrm{T}} (\boldsymbol{C}_{s} + \boldsymbol{C}_{w})^{-1} \v{\mu}_{s} } - \v{\mu}_{s}^{\mathrm{T}} (\boldsymbol{C}_{s} + \boldsymbol{C}_{w})^{-1} \v{\mu}_{s} 
\end{aligned} \\
& \begin{aligned}
...
&\stackrel{\text{Woodbury}}{=\!=\!=\!=\!=\!=} \frac{1}{2} \v{x}^{\mathrm{T}} \boldsymbol{C}_{w}^{-1} \boldsymbol{C}_{s} \left( \boldsymbol{C}_{s} + \boldsymbol{C}_{w} \right)^{-1} \v{x} + \v{x}^{\mathrm{T}} (\boldsymbol{C}_{s} + \boldsymbol{C}_{w})^{-1} \v{\mu}_{s}
\end{aligned}
\end{align}
$$
