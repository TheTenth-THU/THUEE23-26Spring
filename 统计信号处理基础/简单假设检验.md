...
\draw [-{Stealth[scale=1.5]}, ] (5,10.75) -- (6,10.75)node[pos=0.5,above, fill={rgb,255:red,255; green,255; blue,255}, fill opacity=1, text opacity=1, inner xsep=0.080cm, inner ysep=0.085cm, rounded corners=0.020cm]{$x[n]$};
...
$$
\mathrm{SNR} = \frac{\mathbb{E} \left[ y[N-1] ; \mathcal{H}_1 \right]}{\mathrm{var} \left( y[N-1] ; \mathcal{H}_1 \right)}
= 
$$
